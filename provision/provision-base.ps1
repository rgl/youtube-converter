...
# install gtk et al.
# see https://www.gtk.org/download/windows.php
# TODO get the theme from https://github.com/B00merang-Project/Windows-10
Bash @'
#pacman -Ss python3-gobject # list the available gobject packages.
pacman --noconfirm -Sy \
